...
class SaleReport(models.Model):
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        select_ = """
                ...
                CASE WHEN l.product_id IS NOT NULL THEN sum(l.untaxed_amount_to_invoice) ELSE 0 END as untaxed_amount_to_invoice,
                CASE WHEN l.product_id IS NOT NULL THEN sum(l.untaxed_amount_invoiced) ELSE 0 END as untaxed_amount_invoiced,
                count(*) as nbr,
                s.name as name,
